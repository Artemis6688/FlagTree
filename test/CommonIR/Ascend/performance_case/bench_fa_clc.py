"""Benchmark: flash_attention_fwd (fa_triton_arch_v2) vs PyTorch SDPA.
...
Kernel constraints (fa_triton_arch_v2.py):
...
# ---------------------------------------------------------------------------
# Import flash_attention_fwd from success_case/fa_triton_arch_v2.py
# ---------------------------------------------------------------------------
_HERE = os.path.dirname(os.path.abspath(__file__))
_SUCCESS_DIR = os.path.abspath(os.path.join(_HERE, "..", "success_case"))
sys.path.insert(0, _SUCCESS_DIR)

import fa_triton_arch_v2 as _fa  # noqa: E402
...
def _parse_args():
    p = argparse.ArgumentParser(
        description="Benchmark fa_triton_arch_v2 vs SDPA — clc.yaml dense configs")
